...
public class ScoresProvider extends ContentProvider
{
    ...
    static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(authority, "scores_table/league" , MATCHES_WITH_LEAGUE);
        matcher.addURI(authority, "scores_table/id" , MATCHES_WITH_ID);
        matcher.addURI(authority, "scores_table/date" , MATCHES_WITH_DATE);
        return matcher;
    }
